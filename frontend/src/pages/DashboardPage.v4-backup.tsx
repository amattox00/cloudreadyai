...
const pipelineStages = [
  {
    ...
    description: "Connect collectors or upload CSVs for servers, storage, databases, and apps.",
  },
  {
    ...
    <div className="px-6 py-6 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="border border-gray-200 bg-white rounded-md shadow-sm p-4">
          ...
          {/* Faux bar / chart placeholder */}
          <div className="border border-dashed border-gray-300 rounded-md px-4 py-3 text-xs text-gray-500">
            <p className="mb-2 font-medium text-gray-700">
              Readiness mix preview
            </p>
