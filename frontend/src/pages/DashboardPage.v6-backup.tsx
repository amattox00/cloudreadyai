...
export default function DashboardPage() {
  ...
  return (
    <div className="px-6 py-6 space-y-8">
      {/* Hero header */}
      <div className="border border-gray-200 bg-gradient-to-r from-gray-50 via-white to-gray-50 rounded-xl shadow-sm px-6 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex flex-col items-stretch sm:flex-row sm:items-center gap-3">
          <div className="px-3 py-2 rounded-lg bg-gray-900 text-gray-100 text-xs leading-tight">
            <div className="font-medium">Workspace snapshot</div>
          ...
          <button
            onClick={handleStart}
            className="bg-blue-600 text-white px-5 py-2.5 rounded-md shadow hover:bg-blue-700 text-sm font-medium whitespace-nowrap"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="border border-gray-200 bg-white rounded-lg shadow-sm p-4 flex flex-col gap-4">
          <div>
            <h2 className="text-sm font-semibold text-gray-900">
              Migration Insights Snapshot
            </h2>
            <p className="text-xs text-gray-600">
              Early view of how discovered workloads align to migration
              strategies. Values are illustrative until the Insights engine is
              fully wired.
            </p>
          </div>
          ...
          <div className="border border-dashed border-gray-300 rounded-md px-5 py-4 bg-gray-50/60">
            ...
            <p className="mt-2 text-[11px] text-gray-500 leading-snug">
              ...
              insights per workload group will be available in the{" "}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 border border-gray-200 bg-white rounded-lg shadow-sm">
        ...
        <div className="border border-gray-200 bg-white rounded-lg shadow-sm flex flex-col">
...
function KpiCard(props: {
  ...
  return (
    <div
      className={`border border-gray-200 rounded-lg px-4 py-4 shadow-sm flex flex-col justify-between ${
