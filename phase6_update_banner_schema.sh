...
echo "==[ Phase 6 – Update CloudIntelligenceModeBanner to match /v1/phase6/providers schema ]=="

FRONTEND_DIR="$HOME/cloudreadyai/frontend"
cd "$FRONTEND_DIR"

COMPONENT="src/components/CloudIntelligenceModeBanner.tsx"
...
echo "Updated $COMPONENT to match current /v1/phase6/providers response."
